    ...
    <div className="bg-[#000000]">
      ...
      <section id="partners" className="pt-12 pb-12 border-y border-line" aria-label="Partners">
        <div className="relative overflow-hidden">
          <div className="absolute left-0 top-0 bottom-0 w-24 md:w-[22rem] bg-gradient-to-r from-black to-transparent z-10" />
          <div className="absolute right-0 top-0 bottom-0 w-24 md:w-[22rem] bg-gradient-to-l from-black to-transparent z-10" />

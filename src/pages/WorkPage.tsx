      ...
      <section className="section pt-10 md:py-32 pb-4 md:pb-16 relative overflow-hidden">
        <div className="container-maven">
          <div className="text-start mb-16" style={{ opacity: 1, transform: "none" }}>
            ...
            <p className="text-mist max-w-3xl text-lg leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch mb-14">
            ...
            <div className="space-y-5">
              <div className="glass rounded-3xl p-8 hover:border-maven-light/30 transition-all duration-500" style={{ opacity: 1, transform: "none" }}>
                <div className="flex items-center gap-4 mb-3">
                  <div className="w-12 h-12 rounded-2xl bg-maven/20 flex items-center justify-center flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-code text-maven-light" aria-hidden="true">
              ...
              <div className="glass rounded-3xl p-8 hover:border-maven-light/30 transition-all duration-500" style={{ opacity: 1, transform: "none" }}>
                <div className="flex items-center gap-4 mb-3">
                  <div className="w-12 h-12 rounded-2xl bg-maven-light/20 flex items-center justify-center flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-megaphone text-maven-light" aria-hidden="true">

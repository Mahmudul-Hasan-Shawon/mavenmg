        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 py-14">
            ...
            <div className="flex gap-3 mt-6">
              {site.social.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  data-cursor
                  className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-gray-400 hover:bg-gradient-to-br hover:from-[#612C8B] hover:to-[#8B4FBF] hover:text-white-solid transition-all duration-300 hover:-translate-y-1"
                >
                  {socialSvg[s.label]}
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-mist">
              <li>
                <a href={site.phoneHref} data-cursor className="flex items-start gap-2.5 hover:text-white transition-colors">
                  <i className="fa-solid fa-phone mt-0.5 shrink-0 text-maven-lighter text-[15px]" aria-hidden="true" />
                  {site.phone}
                </a>
              </li>
              <li>
                ...
                >
                  <i className="fa-regular fa-envelope mt-0.5 shrink-0 text-maven-lighter text-[15px]" aria-hidden="true" />
                  {site.email}
                </a>
              </li>
              <li className="flex items-start gap-2.5 text-mist-dim">
                <i className="fa-solid fa-location-dot mt-0.5 shrink-0 text-maven-lighter text-[15px]" aria-hidden="true" />
                <span>
                  {site.address.street}
                  <br />
              ...
              <li className="flex items-start gap-2.5 text-mist-dim">
                <i className="fa-regular fa-clock mt-0.5 shrink-0 text-maven-lighter text-[15px]" aria-hidden="true" />
                {site.hours}
              </li>
            </ul>
          </div>
